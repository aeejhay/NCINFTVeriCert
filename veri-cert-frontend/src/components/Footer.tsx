        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <p className="text-center text-sm">
              © {currentYear} VeriCert. Built with{' '}
              <span className="text-blue-400" role="img" aria-label="heart">
                💙
              </span>{' '}
              for academic integrity.  Developed by Adrian Jandongan | National College of Ireland
            </p>
